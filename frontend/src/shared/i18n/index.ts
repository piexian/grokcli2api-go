...
const resources = {
  "zh-CN": {
    translation: {
      ...
      auth: {
        ...
        adminKey: "管理密钥",
        adminKeyRequired: "请输入管理密钥 (GROK_ADMIN_KEY)",
      ...
      credentials: {
        title: "凭证账号",
        description: "管理 Grok OAuth 凭证池：上传、删除、查看订阅层级、额度与冷却状态。",
        upload: "上传凭证",
        uploadTitle: "上传 Grok OAuth 凭证",
        uploadDescription: "粘贴 auth.json 内容或选择文件。多 scope 文件会导入全部逻辑凭证。",
        pasteJson: "粘贴 JSON",
        uploadFile: "选择文件",
        uploading: "上传中…",
        uploaded: "凭证已保存（模型发现：{{status}}）",
        uploadFailed: "凭证上传失败",
        deleteTitle: "删除凭证？",
        deleteDescription: "凭证文件将从服务器删除并立即移出调度池，无法恢复。",
        deleted: "凭证已删除",
        search: "搜索 ID / scope / 模型…",
        account: "凭证 ID",
        status: "状态",
        tier: "订阅层级",
        models: "模型",
        ...
        actions: "操作",
        total: "共 {{count}} 个凭证",
        usableCount: "{{count}} 可用",
        statusReady: "就绪",
        statusCooling: "冷却中",
        statusDisabled: "已禁用",
        statusNeedsRefresh: "待刷新",
        statusPendingModels: "待发现模型",
        billingExhausted: "已耗尽",
        billingRemaining: "剩余 {{percent}}%",
        noBilling: "未同步",
        refresh: "刷新",
        loadFailed: "获取凭证列表失败",
        noSearchResult: "没有匹配的凭证，试试调整搜索词",
        empty: "暂无凭证，点击右上角上传第一个凭证",
      },
      accounts: {
        title: "上游账号",
  ...
  en: {
    translation: {
      ...
      audits: { loadFailed: "Failed to load request audits", time: "Time", protocol: "Protocol",
